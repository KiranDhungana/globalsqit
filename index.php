...
<div class="flex flex-col mx-[48px] hidden ">
    ...
    <div class="grid mb-[48px]">
        ...
        <div class="md:mx-[132px] mx-[48px] md:grid grid-cols-3 flex flex-row    justify-between mb-[64px] mt-[48px]">
            ...
            <div class="flex flex-col gap-[40px] items-center ">
                <svg class="h-[24px] w-[24px]" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                    viewBox="0 0 25 25" fill="none">
                    <path
                        d="M20.0625 3.84766H4.0625C2.95793 3.84766 2.0625 4.74309 2.0625 5.84766V15.8477C2.0625 16.9522 2.95793 17.8477 4.0625 17.8477H20.0625C21.1671 17.8477 22.0625 16.9522 22.0625 15.8477V5.84766C22.0625 4.74309 21.1671 3.84766 20.0625 3.84766Z"
                        stroke="#5EBE90" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M8.0625 21.8477H16.0625" stroke="#5EBE90" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M12.0625 17.8477V21.8477" stroke="#5EBE90" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            ...
            <div class="flex flex-col gap-[40px] items-center ">
                <svg class="h-[24px] w-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <path
                        ...
                        stroke="#5EBE90" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M12 18H12.01" stroke="#5EBE90" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
                <div class="text-[20px] text-[#101828]  text-center font-[500]">
        ...
        <div id="clippath" class="mb-[50px] h-[352px] bg-[#090914] rounded-[15px]">
            <div class="flex flex-row  justify-between  px-[20px] py-[20px]">
                ...
                <div class="w-[618px] my-[40px]">
                    ...
                    <div class="text-[#FAFAFA] text-justify">
