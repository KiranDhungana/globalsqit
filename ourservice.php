...
<div class="grid mb-[48px]">
    <div class="flex my-[48px] flex-col items-center gap-[12px] ">
    ...
    <div class="mx-[132px] my-[32px] flex flex-row justify-between mb-[64px]">
        <div class="flex flex-col gap-[40px] items-center ">
            <svg class="h-[24px] w-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none">
        ...
        <div class="flex flex-col gap-[40px] items-center ">
            <svg class="h-[24px] w-[24px]" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"
                fill="none">
                <path
    ...
    <div class="mx-[50px] flex flex-row justify-center gap-[35px] ">
        <div class="flex flex-col gap-[40px] items-center ">
            <svg class="h-[24px] w-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 20"
                fill="none">
