...
<div class="grid mx-[132px]">
    ...
    <div class="flex  flex-row font-[400] text-[#A1A1AA] text-[18px] mt-[34px] mb-[48px]">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M9 22V12H15V22" stroke="#A1A1AA" stroke-width="1.5" stroke-linecap="round"
        ...
        <div class="text-[#04A558]">
            / .Net Developer
        </div>
    </div>
    <!-- breadcrumb end  -->

    <div class="text-[#090914] font-[600] text-[28px] mb-[24px]">
        .Net Developer

    </div>
    <div class="grid grid-cols-3 gap-4 mb-[48px]">

        <div class="col-span-2">
            <div class="flex flex-col gap-[24px]">
                <div class="flex flex-row ">
                    <div class="w-[216px] text-[#090914] text-[18px] font-[500] leading-[24px]">
                        Position
                    </div>
                    <div class="w-[402px] text-justify text-[#667085] leading-[26px] font-[400]">
                        Mid Level
                    </div>
                </div>
                <div class="flex flex-row ">
                    ...
                    <div class="w-[402px] text-justify text-[#667085] leading-[26px] font-[400]">
                        We're seeking a skilled .NET Developer to design, develop, and maintain high-performance web
                        applications using the .NET framework. Collaborate with cross-functional teams, write clean
                        code, and contribute to innovative solutions.
                    </div>
                </div>
                <div class="flex flex-row ">
                    <div class="w-[216px] text-[#090914] text-[18px] font-[500] leading-[24px]">
                    ...
                    <div class="w-[402px] text-justify text-[#667085] leading-[26px] font-[400]">
                        Develop and maintain web applications in C# and ASP.NET.
                        <br>
                        Collaborate with cross-functional teams to analyze and implement requirements.
                        <br>
                ...
                <div class="flex flex-row ">
                    ...
                    <div class="w-[402px] text-justify text-[#667085] leading-[26px] font-[400]">
                        ...
                        <br>
                        Proven experience in C#, ASP.NET, MVC.
                        <br>
                        Strong understanding of front-end technologies (HTML, CSS, JavaScript).
                        <br>
                        Knowledge of relational databases (e.g., SQL Server).
                        <br>
                        Experience with source control (e.g., Git) and CI/CD pipelines.
                    </div>
                </div>
                <div class="flex flex-row ">
                    <div class="w-[216px] text-[#090914] text-[18px] font-[500] leading-[24px]">
    ...
    <div class="flex flex-row gap-[32px] my-[48px]">
